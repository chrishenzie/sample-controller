...
type TaskInformer interface {
	...
	Lister() samplecontrollerv1alpha1.TaskLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecontrollerV1alpha1().Tasks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecontrollerV1alpha1().Tasks(namespace).Watch(context.TODO(), options)
			},
		},
		&apissamplecontrollerv1alpha1.Task{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *taskInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apissamplecontrollerv1alpha1.Task{}, f.defaultInformer)
}

func (f *taskInformer) Lister() samplecontrollerv1alpha1.TaskLister {
	return samplecontrollerv1alpha1.NewTaskLister(f.Informer().GetIndexer())
}
